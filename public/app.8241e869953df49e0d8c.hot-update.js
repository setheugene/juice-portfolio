...
function colorToggle() {
  $('#color-toggle').on('click', function () {
    console.log(sessionStorage.getItem('color-mode'));
...
let count = 0;
function init() {
  $('.featured-projects .featured-project_cat-filter-trigger')[0].data('target').replace('.', '');
  if (sessionStorage.getItem('featured-project') === null) {
    sessionStorage.setItem('featured-project', 'branding');
  }
...
//# sourceMappingURL=app.8241e869953df49e0d8c.hot-update.js.map
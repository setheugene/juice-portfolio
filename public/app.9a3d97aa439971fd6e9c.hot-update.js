...
let count = 0;
function init() {
  console.log($('.featured-projects .featured-project_cat-filter-trigger').first().data('target').replace('.', ''));
...
//# sourceMappingURL=app.9a3d97aa439971fd6e9c.hot-update.js.map